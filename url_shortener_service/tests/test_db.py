...
from url_shortener_service.db import DataBase, LongUrl, ShortUrl, UrlMapping
...
async def mock_db(mocker):
	...
	mock_sessionmaker = mocker.patch("url_shortener_service.db.async_sessionmaker", autospec=True)
